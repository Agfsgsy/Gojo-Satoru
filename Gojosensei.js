...
break
	...
	case 'تعديل': case 'التعديل': {
            ...
            case 'antilink': {
             ...
             break
            case 'https://chat.whatsapp.com/FHKkN6M1HZ5CNwMswY9GQp': case 'رابط.الجروب': case 'gclink': case 'grouplink': {
                if (!m.isGroup) return replay(`${mess.group}`)
...
┌─❖ مـرحبـاً 🤗 」
└┬❖ 「 ${pushname} 」
││✑「مـعـك بـوت علي الواقدي 👋🏻」◣
││✑「مـن مـمـلـكـة علي الواقدي 🤗」◣
│└───────────────┈ ⳹
...
let template = await generateWAMessageFromContent(m.chat, proto.Message.fromObject({
 ...
 「 رابط شرح كيف تحقق دخل من هاتفك اكثر من 1000دولار 」◣
		    「https://youtu.be/5CCDjAjooro」◣
